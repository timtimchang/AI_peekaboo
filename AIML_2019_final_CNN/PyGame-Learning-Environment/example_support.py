...
class ExampleAgent():
    ...
    def __init__(self, env, batch_size, num_frames,
        ...
        print "frame_shape: {}".format(self.frame_dim)
        self.state_shape = self.frame_dim + (num_frames,) 
        print "state_shape: {}".format(self.state_shape)
...
def loop_play_forever(env, agent):
    ...
    try:
        ...
        for i in range(10):
            ...
            agent.end_episode()
        print "The average reward is : {:0.1f}".format(total/10.0)
